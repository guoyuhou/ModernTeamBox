...
class Minesweeper:
    ...
    def reveal(self, x, y):
        ...
        if self.board[y][x] == -1:
            ...
            print(f"揭示数字格子 ({x}, {y}): {self.board[y][x]}")
        return True
    ...
    def draw_board(self):
        ...
        text = font.render(f"Remaining Mines: {self.remaining_mines}", True, BLUE)
...
def show_win_popup():
    ...
    text2 = font.render("Click to restart", True, (0, 0, 255))
